        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    userMap.put("status", "RB Leipzig, du bist mein Verein");
                    userMap.put("image", "default");
                    userMap.put("thumb_image", "default");
                    userMap.put("device_token", device_token);
                    userMap.put("banned", "false");
                    userMap.put("rank", "user");
                    userMap.put("online", ServerValue.TIMESTAMP.toString());
                    ...
                    mRegProgress.hide();
                    Toast.makeText(RegisterActivity.this, "Anmeldung fehlgeschlagen. Bitte ändere deine Zugangsdaten", Toast.LENGTH_LONG).show();
